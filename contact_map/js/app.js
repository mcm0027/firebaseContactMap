...
//        meetingTime:"December 25th 2016 6:00 am",
...
myApp.factory('coordinateSearch', ['$http', '$q', function ($http, $q) {
  ...
  service.search = function (address) {
    ...
    var key = "AIzaSyBQUTG432xBTDynIeM5XKMrNGHke4uM0bE"
    var deferred = $q.defer();
    $http.get("http://maps.googleapis.com/maps/api/geocode/json?/js?key=" + key + "&address=" + address + "&sensor=true")
...
myApp.controller('mapController', ['$scope','$firebaseArray', 'coordinateSearch', function ($scope, $firebaseArray ,coordinateSearch) {
  var mainUser = "Linda"
  var mainContact = "0"
  var ref = new Firebase("https://contactmap.firebaseio.com/users");
  $scope.users = $firebaseArray(ref);
  var userRef = new Firebase("https://contactmap.firebaseio.com/users/" + mainUser);
  $scope.userContact = $firebaseArray(userRef);
